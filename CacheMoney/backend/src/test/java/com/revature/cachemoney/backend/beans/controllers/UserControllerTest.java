...
class UserControllerTest {
    ...
    /**
     *
     * Data initialization before each test
     *
     *
     * */
    @BeforeEach
    ...
    /**
     *
     * Testing the ability to retrieve a user with a
     * valid userId
     *
     * */
    @Test
    void getUserById() throws Exception {
        ...
        // Mocking http request with the required headers and checking that the first name
        // matches what the mocked service returns
    ...
    void login() throws JsonProcessingException {
        ...
        // Creating a response entity which we can the access to compare individual values
